...
const routes = application => {
	...
	application.get('/authtest', Middlewares.authenticateBasicUser, UserController.testingAuthenticatedRoute)
	...
	application.put('/user/:userId', Middlewares.authenticateBasicUser, UserController.updateUser)
